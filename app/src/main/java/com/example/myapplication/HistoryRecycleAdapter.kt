...
//Recycleview with object
class HistoryRecycleAdapter(val recycleData: List<CalculatorResult>, val context: Context) :
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindData(item: CalculatorResult) {
            rvTitle.text = item.result
            rvTime.text=item.time
        }
    }
//RecycleView with String
